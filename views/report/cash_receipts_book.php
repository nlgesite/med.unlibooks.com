	...
	<form>
		<div class="monthlyExpensesCont">
			...
			<div class="DFs">
				...
				<div style="float:right;margin-right:207px;margin-top: 3px;">
					<input type="submit" class="FSGen" value="" >
				</div>
				<div style="clear:both;"></div>
				<!--<div style="height:3px;width:720px;background:#183867;margin-top:20px;margin-bottom:20px;"></div>-->
...
<div class="reportHolderContainer trhidden">
	...
	?>	
		<div style="text-align:center;">
			YOU DON'T HAVE CASH RECIEPTS BOOK
		</div>
	<?php
	}
	?>
